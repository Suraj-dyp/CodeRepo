...
public class CobPOJO {
	...
	public CobPOJO(int tradeId, String commodity, double quantity, double tradePrice,
	...
	public CobPOJO(int transferId, int tradeId, String commodity, double quantity, double tradePrice, String tradePriceCurrency,
	...
	public String toString() {
		return "EODAttributes [tradeId=" + tradeId + ", transferId=" + transferId +", commodity=" + commodity + ", quantity=" + quantity
